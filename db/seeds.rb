...
User.create(name: 'Joker', email: 'jl0@gmai1.com', password: '111111', password_confirmation: '111111')
User.create(name: 'Penguin', email: 'jl1@gmai1.com', password: '111111', password_confirmation: '111111')
User.create(name: 'Superman', email: 'jl2@gmai1.com', password: '111111', password_confirmation: '111111')
User.create(name: 'Bane', email: 'jl3@gmai1.com', password: '111111', password_confirmation: '111111')
User.create(name: 'Catwoman', email: 'jl4@gmai1.com', password: '111111', password_confirmation: '111111')
